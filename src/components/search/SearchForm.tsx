...
import { Select } from "..";
import { createFilterList, DEFAULT_OPTION_VALUE } from "../../utils";
    ...
    return (
        <section id="searchForm">
            ...
            <article id="searchFilters">
                <Select title={"Category"} list={createFilterList("category")} defaultOption={true} getOption={setCategory} />
                <Select title={"Publisher"} list={createFilterList("publisher")} defaultOption={true} getOption={setPublisher} />
                <Select title={"Developer"} list={createFilterList("developer")} defaultOption={true} getOption={setDeveloper} />
            </article>
